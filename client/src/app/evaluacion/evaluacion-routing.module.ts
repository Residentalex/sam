...
const routes: Routes = [
  { path: 'evaluacion-method', component: EvaluacionMethodComponent, data: { breadcrumb: 'Metodo de Evaluación' } },
  { path: 'evaluacion-record', component: EvaluacionRecordComponent }
];

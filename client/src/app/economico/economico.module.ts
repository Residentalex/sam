...
@NgModule({
  declarations: [
    EconomicoConceptsComponent,
    EconomicoPaymentsPlansComponent,
    EconomicoPaymentsComponent,
    EconomicoIncomesComponent,
    EconomicoExpensesComponent,
    EconomicoCashSummaryComponent,
    EconomicoAccountsComponent,
    EconomicoDocumentsSearchComponent,
    EconomicoDocumentsCancelComponent,
